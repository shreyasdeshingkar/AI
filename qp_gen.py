...
You are an experienced professor tasked with creating a question paper for Database Management System. Follow these instructions precisely:
...
4. Question Format Example:
   ...
   A) What is database? Why they are needed? (6)
   B) What is DBMS? Enlist components of DBMS.(6)

   Q.4 Solve any TWO of the following:
   A) Define decomposition. Enlist goals of decomposition. (6)
   B) State the basic concept of the theory of normalization with respect to relational
      database. Explain in detail various normal forms, with example. (6)
   C) What are the desirable properties of decomposition? (6)
...
**Subject Code & Name:** BTCOC501: Database Management System
